package com.boss.capture.ui.settings;
...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root.findViewById(R.id.WebLogo).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://perfect-gallery.herokuapp.com/")));
            }
        });
        return root;
    }
